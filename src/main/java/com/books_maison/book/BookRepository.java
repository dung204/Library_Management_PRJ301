...
public interface BookRepository extends JpaRepository<Book, String> {
  ...
  @Query(
    value = "SELECT b " + "FROM Book b " + "JOIN b.categories bc " + "WHERE bc.id IN (:categoryIds)",
    countQuery = "SELECT COUNT(b) " + "FROM Book b " + "JOIN b.categories bc " + "WHERE bc.id IN (:categoryIds)"
  )
  Page<Book> findByCategoryIdsIn(Pageable pageable, List<String> categoryIds);

  @Query(
    value = "SELECT b " + "FROM Book b " + "JOIN b.authors ba " + "WHERE ba.id = :authorId",
    countQuery = "SELECT COUNT(b) " + "FROM Book b " + "JOIN b.authors ba " + "WHERE ba.id = :authorId"
  )

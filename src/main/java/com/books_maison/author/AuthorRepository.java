...
public interface AuthorRepository extends JpaRepository<Author, String> {
  ...
  Page<Author> findByContainingBooksWithCategoriesIn(
    Pageable pageable, @Param("categoryIds") List<String> categoryIds);
  ...
  Page<Author> findByAllCriteriaContainingIgnoreCaseAndContainingBooksWithCategoriesIn(
    Pageable pageable, @Param("keyword") String keyword, @Param("categoryIds") List<String> categoryIds);
}
